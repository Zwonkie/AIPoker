...
Run:  .venv/Scripts/python.exe -m versions.v12_validated.self_play.eval_pure_policy
"""
import os
import sys
...
def main():
    ...
    print("  " + "-" * 82)
    run_field(model, "Loose (fish/tag/nit) live4", ['fish', 'tag', 'nit'], [0.45, 0.30, 0.25], 4)
    run_field(model, "Tight (nit/tag) live3",      ['nit', 'tag'],         [0.50, 0.50],        3)
    run_field(model, "Calling stations only live3", ['fish'],              [1.0],               3)
