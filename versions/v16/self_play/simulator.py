...
from versions.v16.self_play.opponent_bots import TAG, LAG, NIT, CALLING_STATION
...
def compute_range_aware_equity(hero_cards_str, board_str, opp_colors, noise=True, sims=150):
    ...
    consistency — see versions/v16/VALIDATED_FINDINGS.md). Returns equity in [0,1], or None if
...
class SixMaxSimulator:
    ...
    def _query_model_decide(self, model, hand_cards, equity, pot_size, call_amount, hero_stack, num_opponents, table_state_dict=None, model_state_history=None, hero_actions_history=None, sample=True):
        ...
        from versions.v16.core.contract import ContractV12
