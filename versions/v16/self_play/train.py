...
from versions.v16.core.model import PokerEVModelV4
from versions.v16.self_play.simulator import SixMaxSimulator
from versions.v16.core.manifest import MANIFEST
...
def run_training(personality, num_hands=100000, batch_size=256, epochs_per_batch=3,
    ...
    from versions.v16.self_play.telemetry import TrainingTelemetry
    ...
    if range_aware_equity:
        from versions.v16.self_play.simulator import _get_preflop_ranked
