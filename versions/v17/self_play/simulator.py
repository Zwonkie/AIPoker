...
from versions.v17.self_play.opponent_bots import TAG, LAG, NIT, CALLING_STATION
...
def compute_range_aware_equity(hero_cards_str, board_str, opp_colors, noise=True, sims=150):
    ...
    consistency — see versions/v17/VALIDATED_FINDINGS.md). Returns equity in [0,1], or None if
