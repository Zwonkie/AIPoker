...
from versions.v17.core.model import PokerEVModelV4
from versions.v17.self_play.simulator import SixMaxSimulator
from versions.v17.core.manifest import MANIFEST
...
def run_intermediate_sensitivity_check(model, step_label, device):
    ...
    from versions.v17.core.contract import ContractV12
...
def run_training(personality, num_hands=100000, batch_size=256, epochs_per_batch=3,
    ...
    #    (0.5) regardless of disable_target_shaping. See versions/v17/SPECS.md.
    ...
    from versions.v17.self_play.telemetry import TrainingTelemetry
    ...
    if range_aware_equity:
        from versions.v17.self_play.simulator import _get_preflop_ranked
