...
from versions.v25.self_play.opponent_bots import TAG, LAG, NIT, CALLING_STATION, STYLE_SHIFT_SCALE
from versions.v25.self_play.opponents import HeuristicOpponent, build_opponent_pool
...
# signal"). See versions/v25/SPECS.md for the full calibration write-up.
...
class SixMaxSimulator:
    ...
    def _query_model_decide(self, model, hand_cards, equity, pot_size, call_amount, hero_stack, num_opponents, table_state_dict=None, model_state_history=None, hero_actions_history=None, sample=True):
        ...
        from versions.v25.core.contract import ContractV12
    ...
    def _ev_target_fold_decision(self, bot, equity, pot_odds, street_idx, is_allin):
        ...
        Root cause this decoupling fixes (see versions/v23/SPECS.md, versions/v25/SPECS.md): V23
    ...
    def _mc_target_evs_sized(self, hero_cards, pot, to_call, hero_stack, street_idx,
        ...
        versions/v23/SPECS.md, versions/v25/SPECS.md). Still size-aware (a bigger bet earns more
