...
MANIFEST = VersionManifest(
    ...
    contract_version=2,             # tensor schema unchanged; v13 changes the equity COMPUTATION
                                    # (range-aware) not the feature layout, so no contract bump
    action_space=("fold", "call", "raise"),
    model_class="versions.v13.core.model:PokerEVModelV4",
