...
from versions.v24.core.model import PokerEVModelV4
from versions.v24.self_play.simulator import SixMaxSimulator, OPPONENT_POOL_STYLES, OPPONENT_POOL_WEIGHTS, STYLE_SLOT
from versions.v24.core.manifest import MANIFEST
from versions.v24.self_play.opponents import build_opponent_pool, describe_pool_entry
...
from versions.v24.core.contract import (
...
def run_intermediate_sensitivity_check(model, step_label, device):
    ...
    from versions.v24.core.contract import ContractV12, preflop_hand_strength
...
def run_training(personality, num_hands=100000, batch_size=256, epochs_per_batch=3,
    ...
    from versions.v24.self_play.telemetry import TrainingTelemetry
    ...
    if range_aware_equity:
        from versions.v24.self_play.simulator import _get_preflop_ranked
