...
from versions.v40.self_play.opponent_bots import TAG, LAG, NIT, CALLING_STATION, STYLE_SHIFT_SCALE
from versions.v40.self_play.opponents import HeuristicOpponent, build_opponent_pool
from versions.v40.core.contract import preflop_hand_strength
...
class SixMaxSimulator:
    ...
    def _query_model_decide(self, model, hand_cards, equity, pot_size, call_amount, hero_stack, num_opponents, table_state_dict=None, model_state_history=None, hero_actions_history=None, sample=True):
        ...
        from versions.v40.core.contract import ContractV12
                ...
                if not folded[current_actor] and stacks[current_actor] > 0:
                    ...
                    if current_actor == 0:  # Hero
                        ...
                        if decision == 'fold':
                            ...
                            # `all_matched` that can never become true -- i.e. a hung hand. Reachable
                            # only once stacks are asymmetric (see the review's M5), but the [BET-3]
                            # round fix above makes betting rounds far longer, so guard it now.
