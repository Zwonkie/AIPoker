...
Run:  .venv/Scripts/python.exe -m versions.v20_preflopEq.self_play.inspect_policy_vs_target
"""
import os
import sys
import math
...
import versions.v20_preflopEq.self_play.train as T
from versions.v20_preflopEq.core.model import PokerEVModelV4
from versions.v20_preflopEq.core.manifest import MANIFEST
from versions.v20_preflopEq.self_play.simulator import SixMaxSimulator
...
def part_b(model, device):
    ...
    from versions.v20_preflopEq.core.contract import ContractV12
