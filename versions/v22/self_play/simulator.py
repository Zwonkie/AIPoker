...
from versions.v22.self_play.opponent_bots import TAG, LAG, NIT, CALLING_STATION
from versions.v22.self_play.opponents import HeuristicOpponent, build_opponent_pool
from versions.v22.core.contract import preflop_hand_strength
...
class HandRecordV4:
    ...
    def add_decision(self, step, street, board, hero_position, pot_size, big_blind,
                     ...
                     hand_strength=0.5, opponents_committed=None):
...
class SixMaxSimulator:
    ...
    def _query_model_decide(self, model, hand_cards, equity, pot_size, call_amount, hero_stack, num_opponents, table_state_dict=None, model_state_history=None, hero_actions_history=None, sample=True):
        ...
        from versions.v22.core.contract import ContractV12
