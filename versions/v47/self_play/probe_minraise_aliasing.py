...
Run:  .venv/Scripts/python.exe versions/v47/self_play/probe_minraise_aliasing.py
"""
import os
import random
import sys
...
def main():
    ...
    models = {'v47': load_model('v47', 'expert_main.pth'),
              'v44_frozen': load_model('v47', 'frozen_v44.pth')}
