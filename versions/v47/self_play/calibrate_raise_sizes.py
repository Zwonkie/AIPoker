...
Run:  .venv/Scripts/python.exe versions/v47/self_play/calibrate_raise_sizes.py [--hands 1000]
"""
import argparse
import copy
import os
...
def c1_static():
    from versions.v47.self_play.opponent_bots import (RAISE_SIZE_DISTRIBUTIONS,
