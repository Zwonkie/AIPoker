...
Run:  .venv/Scripts/python.exe versions/v47/self_play/verify_v47.py
"""
import os
import random
import sys
...
def main():
    ...
    from versions.v47.self_play.simulator import SixMaxSimulator, HandRecordV4
    from versions.v47.self_play.opponents import HeuristicOpponent, NNOpponent
    from versions.v47.self_play.tree_opponent import TreeOpponent
    from versions.v47.self_play import train as v47_train
    from versions.v47.self_play.opponent_bots import (FuzzyPlayerArchetype, TAG, NIT,
    ...
    check("LAG repertoire samples jams near configured 12%", 0.08 < jam_rate < 0.16, f"jam_rate={jam_rate:.3f}")
    check("station repertoire never jams", all(sample_raise_fraction('fish') is not None for _ in range(2000)))
