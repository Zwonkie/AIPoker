...
Run:  .venv/Scripts/python.exe -m versions.v21.self_play.inspect_policy_vs_target
"""
import os
import sys
import math
...
import versions.v21.self_play.train as T
from versions.v21.core.model import PokerEVModelV4
from versions.v21.core.manifest import MANIFEST
from versions.v21.self_play.simulator import SixMaxSimulator
...
def part_b(model, device):
    ...
    from versions.v21.core.contract import ContractV12
