...
Run: .venv/Scripts/python.exe -m versions.v26.self_play.calibrate_multistreet_ev
"""
import random

from versions.v26.self_play.simulator import SixMaxSimulator, _poker_evaluator
from versions.v26.self_play.opponent_bots import TAG, LAG, NIT, CALLING_STATION
