...
Run:  .venv/Scripts/python.exe -m versions.v20_preflopEq_AI.self_play.inspect_policy_vs_target
"""
import os
import sys
import math
...
import versions.v20_preflopEq_AI.self_play.train as T
...
from versions.v20_preflopEq_AI.self_play.simulator import SixMaxSimulator
...
def part_b(model, device):
    ...
    from versions.v20_preflopEq_AI.core.contract import ContractV12
