...
MANIFEST = VersionManifest(
    version_id="v29",
    context_dim=54,                  # [V29, OPP-2] 44 -> 54: +10 per-opponent-seat raise features
    contract_version=8,              # [V29, OPP-2] 7 -> 8
    action_space=("fold", "call", "raise_33", "raise_66", "raise_pot", "allin"),
    model_class="versions.v29.core.model:PokerEVModelV4",
    contract_class="versions.v29.core.contract:ContractV12",
    weights_dir="versions/v29/weights",
    status="training",
    milestone=False,
)
