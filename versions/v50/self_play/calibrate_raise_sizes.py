...
Run:  .venv/Scripts/python.exe versions/v50/self_play/calibrate_raise_sizes.py [--hands 1000]
"""
import argparse
import copy
import os
...
def c1_static():
    from versions.v50.self_play.opponent_bots import (RAISE_SIZE_DISTRIBUTIONS,
...
def c2_instrumented(n_hands, weights='frozen_v47.pth'):
    from versions.v50.self_play.simulator import SixMaxSimulator
    from versions.v50.self_play.opponents import build_opponent_pool
