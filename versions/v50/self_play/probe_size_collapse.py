...
Run:  .venv/Scripts/python.exe -m versions.v50.self_play.probe_size_collapse --hands 300
"""
import argparse
import os
import sys
...
from versions.v50.self_play.opponents import build_opponent_pool  # noqa: E402
