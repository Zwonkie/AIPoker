...
Run:  .venv/Scripts/python.exe -m versions.v50.self_play.inspect_aux_heads --weights expert_main.pth
"""
import os
import sys
import argparse
...
import versions.v50.self_play.train as T
from versions.v50.self_play.simulator import SixMaxSimulator
