...
Run:  .venv/Scripts/python.exe versions/v50/self_play/verify_v47.py
"""
import os
import random
import sys
...
def main():
    ...
    from versions.v50.self_play.simulator import SixMaxSimulator, HandRecordV4
    from versions.v50.self_play.opponents import HeuristicOpponent, NNOpponent
    from versions.v50.self_play.tree_opponent import TreeOpponent
    from versions.v50.self_play import train as v47_train
    from versions.v50.self_play.opponent_bots import (FuzzyPlayerArchetype, TAG, NIT,
