...
from versions.v43.self_play.opponent_bots import TAG, LAG, NIT, CALLING_STATION, STYLE_SHIFT_SCALE
from versions.v43.self_play.opponents import HeuristicOpponent, build_opponent_pool
from versions.v43.core.contract import preflop_hand_strength
...
class SixMaxSimulator:
    ...
    def _query_model_decide(self, model, hand_cards, equity, pot_size, call_amount, hero_stack, num_opponents, table_state_dict=None, model_state_history=None, hero_actions_history=None, sample=True):
        ...
        from versions.v43.core.contract import ContractV12
