...
from versions.v43.core.model import PokerEVModelV4
from versions.v43.self_play.simulator import SixMaxSimulator, OPPONENT_POOL_STYLES, OPPONENT_POOL_WEIGHTS, STYLE_SLOT
from versions.v43.core.manifest import MANIFEST
from versions.v43.self_play.opponents import build_opponent_pool, describe_pool_entry
...
from versions.v43.core.contract import (
...
def run_intermediate_sensitivity_check(model, step_label, device):
    ...
    from versions.v43.core.contract import ContractV12, preflop_hand_strength
...
def run_training(personality, num_hands=100000, batch_size=256, epochs_per_batch=3,
    ...
    from versions.v43.self_play.telemetry import TrainingTelemetry
    ...
    if range_aware_equity:
        from versions.v43.self_play.simulator import _get_preflop_ranked
...
if __name__ == '__main__':
    ...
    # [V43] Was a FIXED `active_training.log` opened in 'w' mode, so every version's training run
    # silently overwrote the previous one's telemetry -- V43's own run destroyed V41's log before
    # this was noticed. The per-version `active_training_v19/v20/.../v28.log` files sitting next to
