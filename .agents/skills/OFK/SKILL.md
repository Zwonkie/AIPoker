...
*   [V12 Issues & Fixes](file:///c:/REPO/Antigravity/AIPoker/.agents/skills/OFK/references/V12/issues-and-fixes.md): Running log of V12 defects and remediations — PyTorch Transformer key_padding_mask bug/NaN crash, and context alignment mismatch between `train.py` and `ContractV12`.
